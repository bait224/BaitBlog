...
namespace FA.JustBlog
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new CustomUserStore(context.Get<JustBlogContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole, int>
    {
        ...
        public static ApplicationRoleManager Create(IdentityFactoryOptions<ApplicationRoleManager> options, IOwinContext context)
        {
            ...
            var appRoleManager = new ApplicationRoleManager(new CustomRoleStore(context.Get<JustBlogContext>()));
